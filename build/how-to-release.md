...
- Go to https://central.sonatype.com/publishing/deployments and publish the release.
- Wait for the release to appear in Maven Central - https://repo1.maven.org/maven2/io/github/kkuegler/typescript-generator/
- write release notes
