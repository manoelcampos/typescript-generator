...
public class JaxrsApplicationParserTest {
    ...
    public void testJakartaAnnotation() {
        final ApplicationPath annotation = JaxrsApplicationParser.getRsAnnotation(JakartaRsClass.class,
    ...
    public void testJavaxAnnotation() {
        final ApplicationPath annotation = JaxrsApplicationParser.getRsAnnotation(JavaxRsClass.class,
                jakarta.ws.rs.ApplicationPath.class);
        Assertions.assertNotNull(annotation);
