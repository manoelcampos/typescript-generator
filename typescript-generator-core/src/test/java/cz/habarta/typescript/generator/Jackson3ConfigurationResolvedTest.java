...
public class Jackson3ConfigurationResolvedTest {
    ...
    public void test() {
        ...
        configuration.serializerTypeMappings = Arrays
                .asList(Jackson3ParserTest.IdSerializer.class.getName() + ":" + "string");
        final Jackson3ConfigurationResolved resolved = Jackson3ConfigurationResolved.from(configuration,
