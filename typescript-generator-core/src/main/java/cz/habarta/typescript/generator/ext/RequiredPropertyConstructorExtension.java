    ...
    private static Optional<TsConstructorModel> createConstructor(TsBeanModel bean, TsModel model,
        ...
        if (parent != null) {
            ...
            if (parentConstructor == null) {
                throw new IllegalStateException(
                        "Generating constructor for class with non-generated constructor is not currently supported");
            }
            ...
            for (TsParameterModel parentParameter : parentParameters) {
                List<TsParameterModel> targetParameterList = parentParameter.tsType instanceof TsType.OptionalType
                        ? optionalParameters
                        : parameters;
        ...
        for (TsPropertyModel property : bean.getProperties()) {
            ...
            if (predefinedValue.isPresent()) {
                ...
                List<TsParameterModel> targetParameterList = property.tsType instanceof TsType.OptionalType
                        ? optionalParameters
                        : parameters;
